...
internal val TOKENS = listOf(
    ...
    RealToken.valueOf("0.0".toBigDecimal()),
    RealToken.valueOf("+0.0".toBigDecimal()),
    RealToken.valueOf("-0.0".toBigDecimal()),
    RealToken.valueOf("1.234".toBigDecimal()),
    RealToken.valueOf("1.234e0".toBigDecimal()),
    RealToken.valueOf("1.234e10".toBigDecimal()),
    RealToken.valueOf("1.234e-10".toBigDecimal()),
    RealToken.valueOf("1.234e10".toBigDecimal()),
    RealToken.valueOf("-1.234e-10".toBigDecimal()),
    RealToken.valueOf("1.234567890987654321e100".toBigDecimal()),
    RealToken.valueOf("1.223334444555556666667777777888888889999999990e1234567890".toBigDecimal()),
    RealToken.valueOf("122333.455666e-2".toBigDecimal()),
